class NetworkConfig {
  ...
  factory NetworkConfig.fromJson(Map<String, dynamic> json) {
    return NetworkConfig(
      ...
      stunServers: json['stun_server'] != null ? List<String>.from(json['stun_server']) : [],
      inIps: json['in_ips'] != null ? List<String>.from(json['in_ips']) : [],
      outIps: json['out_ips'] != null ? List<String>.from(json['out_ips']) : [],
      portMappings: json['mapping'] != null ? List<String>.from(json['mapping']) : [],
      groupPassword: json['password'] ?? '',
      isServerEncrypted: json['server_encrypt'] ?? false,
      protocol: json['protocol'] ?? 'UDP',
      dataFingerprintVerification: json['finger'] ?? false,
      encryptionAlgorithm: json['cipher_model'] ?? '',
      deviceID: json['device_id'] ?? '',
      virtualNetworkCardName: json['device_name'] ?? '',
      mtu: json['mtu'] ?? 1400,
      ports: json['ports'] != null ? List<int>.from(json['ports']) : [],
      firstLatency: json['first_latency'] ?? false,
      noInIpProxy: json['no_proxy'] ?? false,
      dns: json['dns'] != null ? List<String>.from(json['dns']) : [],
      simulatedPacketLossRate: json['packet_loss'] ?? 0.0,
      simulatedLatency: json['packet_delay'] ?? 0,
